...
class PDFConverter:
    def __init__(self, pathname, export='.'):
        ...
        self._export_folder = os.path.join(os.path.abspath('.'), 'pdfconver')                   #os.path.join 拼接路径
    ...
    def _enumerate_filename(self, pathname):
        ...
        读取所有文件名
        '''
        full_pathname = os.path.abspath("C:/Users/Administrator/Desktop/委托书/备用/")                  #使用的修改路径
        #print(full_pathname)
